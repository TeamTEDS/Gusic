module.exports = {
  OWNER_IDS: ["446341204624408586"], // Bot owner ID's
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "545669263994650625", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#990000",
    TRANSPARENT: "#36393F",
